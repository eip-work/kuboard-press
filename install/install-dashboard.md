...
* Kuboard v3.0 已经正式发布，相较于 Kuboard v2.0.x， Kuboard v3 最大的特点是支持多 Kubernetes 集群管理。如果您是 Kuboard 的新用户，建议您选择 [Kuboard v3](./v3/install-built-in.html)。

* Kuboard v2.0.x 将进入长期维护阶段，如果碰到问题，用户仍然可以在群里找群主解决问题。如果您计划升级到 Kuboard v3，请参考 [从 v2.0.x 升级到 v3.0.x](/support/change-log/upgrade-2-3.html)
