let sidebar = {
  "/overview/": [
    {
      title: "简介",
      collapsable: false,
      children: ["", "share-coder"],
    },
    {
      title: "概念",
      collapsable: false,
      children: ["quick-win", "why-kuboard", "concepts"],
    },
  ],
  ...
  "/articles/": [
    {
      title: "文章",
      collapsable: false,
      children: ["201908/kuboard-view-of-k8s"],
    },
  ],
  ...
  "/learning/": [
    {
      ...
      collapsable: true,
      sidebarDepth: 3,
      children: ["", "k8s-bg/what-is-k8s", "k8s-bg/component"],
    },
    {
      title: "Kubernetes 入门",
      collapsable: true,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            "k8s-advanced/ts/deployment",
            {
              title: "KuboardProxy",
              collapsable: true,
              children: ["k8s-advanced/proxy/", "k8s-advanced/proxy/rebase"],
            },
          ],
        },
        {
        ...
        "k8s-advanced/gc",
        {
          title: "自动伸缩",
          collapsable: true,
          children: ["k8s-advanced/hpa/hpa", "k8s-advanced/hpa/walkthrough"],
        },
        {
          title: "监控及告警",
          collapsable: true,
        ...
        },
        {
          title: "扩展Kubernetes",
          collapsable: true,
          children: ["k8s-advanced/extend/aggregation.html"],
        },
      ],
    },
    {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: ["k8s-practice/ocp/export", "k8s-practice/ocp/import"],
            },
          ],
        },
      ],
  ...
  "/guide/": [
    ...
    },
    {
      title: "Example",
      collapsable: true,
      children: ["example/busybox", "example/import", "example/monitor-v2"],
    },
    {
      title: "集群管理",
      collapsable: true,
      children: ["cluster/computing", "cluster/storage", "cluster/namespace"],
    },
    {
      title: "应用管理",
      collapsable: true,
    ...
    },
    {
      title: "套件",
      collapsable: false,
      children: ["addon/", "addon/customize", "addon/api", "addon/repository"],
    },
    {
      title: "监控套件",
      collapsable: false,
